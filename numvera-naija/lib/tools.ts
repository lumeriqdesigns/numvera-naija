...
export const tools: Tool[] = [
  ...
  {
    slug: "minimum-score-checker",
    name: "Minimum Score Checker",
    description: "Enter your UTME score and see which schools’ cut-off guides you meet.",
    category: "Education",
    href: "/tools/minimum-score-checker",
    icon: Target,
    featured: true,
  },
  {
    slug: "subject-combination-checker",
    name: "JAMB Subject Combination Checker",
    description: "Correct UTME subjects for Medicine, Law, Nursing, Engineering, Accounting and more.",
    category: "Education",
  ...
  {
    slug: "post-utme-deadlines",
    name: "Post-UTME Deadlines 2026",
    description: "Form and screening status for UNILAG, UI, OAU, LASU and other universities.",
    category: "Education",
  ...
  },
  {
    ...
    description: "Monthly campus budget in naira — allowance, NELFUND upkeep, hostel and food.",
    category: "Money",
    href: "/tools/student-budget-calculator",
    icon: PiggyBank,
    featured: true,
  },
  ...
  {
    slug: "neco-calculator",
    name: "NECO / NABTEB Points Calculator",
    description: "Sum NECO or NABTEB best 5 and best 8 grade points for admission planning.",
    category: "Education",
    href: "/tools/neco-calculator",
    icon: BookOpen,
    featured: true,
  },
  {
    ...
    description: "Same UTME & Post-UTME — see aggregate under two schools' formulas and cut-off guides.",
    category: "Education",
