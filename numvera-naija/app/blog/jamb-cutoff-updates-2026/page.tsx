...
<p className="mt-4 leading-7 muted">Tip: compare two schools with the same scores using the <Link className="font-bold text-brand-600" href="/tools/compare-universities">compare tool</Link>.</p>
