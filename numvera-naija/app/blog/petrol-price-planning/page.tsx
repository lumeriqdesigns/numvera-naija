...
<p className="leading-7 muted">Our <a className="font-bold text-brand-600" href="/tools/fuel-calculator">fuel calculator</a> includes 90+ interstate routes across SW, SS, SE, NC, NW and NE. Enter your car’s km per litre and today’s pump price.</p>
