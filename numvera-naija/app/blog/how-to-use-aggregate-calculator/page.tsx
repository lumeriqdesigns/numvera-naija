...
<p className="mt-4 leading-7 muted">Open the <a className="font-bold text-brand-600" href="/tools/jamb-calculator">JAMB aggregate calculator</a> and switch models, or open a school-specific page for 100+ universities.</p>
<p className="mt-4 leading-7 muted">Read the longer guide: <a className="font-bold text-brand-600" href="/guides/jamb-aggregate-explained">How JAMB aggregate is calculated</a>.</p>
