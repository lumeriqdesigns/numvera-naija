...
export default function JambPage() {
  ...
  return (
    <ToolLayout
      ...
      description="Combine UTME and Post-UTME (and O'Level) using common Nigerian university weightings. Open a school-specific page for UNILAG, UI, OAU, ABU and 26 more."
    >
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((u) => (
            ...
            >
              ...
              <p className="mt-2 text-xs muted">UTME cut-off guide: <strong>{u.generalUtmeCutoff}+</strong></p>
            </Link>
          ))}
        </div>
