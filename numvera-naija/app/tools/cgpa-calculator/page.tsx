...
export default function CGPAPage() {
  ...
  return (
    ...
    >
      ...
      <FaqBlock
        items={[
          { q: "What is CGPA?", a: "Cumulative Grade Point Average — the average of all your course grade points weighted by credit units." },
          { q: "What class of degree is 4.5 on a 5-point scale?", a: "Typically First Class (often 4.50–5.00). Exact bands can vary slightly by institution." },
          { q: "Can I print my CGPA result?", a: "Yes. Use Print / Save PDF under the result to open your browser print dialog and save as PDF." },
        ]}
      />
