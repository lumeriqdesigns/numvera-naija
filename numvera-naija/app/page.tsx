    ...
    <main>
      <section className="bg-[#f7f9f8] py-16 sm:py-24">
        <div className="container grid items-center gap-12 lg:grid-cols-[1.15fr_.85fr]">
          <div>
            <div className="mb-5 inline-flex rounded-full border border-[#cfe7d7] bg-white px-3 py-1 text-sm font-bold text-brand-600">
              Built for Nigeria · Free forever
            </div>
            <h1 className="max-w-3xl text-4xl font-extrabold tracking-[-.045em] sm:text-5xl lg:text-6xl">
              Practical calculators for Nigerian life
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 muted">
              Salary & PAYE, CGPA, NYSC allowance, fuel costs, loans and more — clear numbers without the clutter.
            </p>
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/tools" className="btn btn-primary">
                Explore all tools <ArrowRight size={17} />
              </Link>
              <a href="#popular" className="btn btn-secondary">
                Popular tools
              </a>
            </div>
            <div className="mt-8 flex max-w-xl items-center gap-3 rounded-2xl border border-[#dfe6e1] bg-white p-3 shadow-soft">
          ...
          <div className="hidden lg:block">
            <div className="card p-7">
              ...
              <h2 className="mt-6 text-2xl font-extrabold">Nigeria-first, not generic.</h2>
